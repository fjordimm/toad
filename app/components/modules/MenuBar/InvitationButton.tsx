...
function InvitationButton(props: {name: string; }){
  ...
  <div className="flex items-center justify-between bg-sidebar_button_bg py-2 px-4 rounded-lg shadow-md w-4/5 max-w-xs">
    ...
    <div className="flex items-center space-x-4">
      {/* Check Button */}
      <button className="relative bg-[#6EBA5D] rounded-full h-8 w-8 flex items-center justify-center shadow-sm">
      ...
      {/* Cross Button */}
      <button className="relative bg-[#D86D6D] rounded-full h-8 w-8 flex items-center justify-center shadow-sm">
